function bookSystem(){  // 书 系统
    ...
    function fillBooks(baseBook, totalLength = 1.05, count = 30) {
        ...
        const rawDepths = Array.from({ length: count }, (_, i) =>
            baseBook.d * (0.9 + (1 - random[i * ks + 1]) * 0.8) // 深度变化 ±40%
        );
    ...
    <svg xmlns="http://www.w3.org/2000/svg"
     viewBox="0 0 1190 840"
     width="1190" height="840"
     preserveAspectRatio="xMidYMid meet"
     role="img"
     aria-label="三个红色方块 与 你好啊">
  ...
  <rect x="160" y="35" width="40" height="50" fill="#e63946" rx="4"/>
    ...
    <text x="450" y="270"
        font-family="'Noto Sans SC', 'PingFang SC', 'Microsoft Yahei', 'Heiti SC', 'Source Han Sans SC', sans-serif"
        font-size="20"
        fill="#000"
        text-anchor="middle"
